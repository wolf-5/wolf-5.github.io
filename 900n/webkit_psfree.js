...
async function run_psfree() {
    StartTimer();
    progress.innerHTML="[+] Webkit exploit (PSFree) <font color=#fc0404> (Step 0 - Readying)";
    await get_ready();

    progress.innerHTML="[+] Webkit exploit (PSFree) <font color=#fc0404> (Step 1 - UAF)";
    ...
    progress.innerHTML="[+] Webkit exploit (PSFree) <font color=#fc0404>(Step 2 - Double free)";
    ...
    progress.innerHTML="[+] Webkit exploit (PSFree) <font color=#fc0404> (Step 2 - Triple free)";
    ...
    EndTimer();
    progress.innerHTML="[+] Webkit exploit (PSFree) <font color=#2afa0a> (Finished)";
    window.p = prim;
    run_hax();
}
